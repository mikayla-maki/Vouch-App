...
<!-- TODO: Describe what Vouch is and its purpose -->

## Project Overview

<!-- TODO: Explain the core functionality of Vouch -->

## Architecture

<!-- TODO: Describe how the application is structured -->

## How It Works

<!-- TODO: Explain the main workflows and features -->
...
Before using any gpui-component features, you must call:
```rust
...
The first level element in a window should be a `Root`:
```rust
cx.open_window(options, |window, cx| {
    let view = cx.new(|_cx| MyView::new());
...
To use button style variants like `.primary()`, import the `ButtonVariants` trait:
```rust
